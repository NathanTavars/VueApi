  ...
  <div class="h-[calc(100vh-50px)] bg-indigo-500 px-4">
        <div class="rounded-md p-[20px] h-full">
          <div class="w-full flex justify-between py-5">
            <h3 class="text-5xl font-bold text-left text-white">Clientes</h3>
            ...
            <div v-if="modalOpen" class="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50 top-0">
                <div class="absolute top-5 right-16 left-96 bg-white p-8 rounded-lg shadow">
                  ...
                  <form class="mb-6">
                    <label for="id" class="block text-sm font-medium text-gray-700">ID do Cliente</label>
                    ...
                    <input v-model="form.cor" type="number" class="mt-1 p-2 border border-gray-300 rounded-md w-full" required>

                    <label for="valor" class="block mt-4 text-sm font-medium text-gray-700">CEP </label>
